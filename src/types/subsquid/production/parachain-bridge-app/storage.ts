...
export const assetKinds =  {
    v64: new StorageType('ParachainBridgeApp.AssetKinds', 'Optional', [v64.SubNetworkId, v64.AssetId32], v64.Type_541) as AssetKindsV64,
    v70: new StorageType('ParachainBridgeApp.AssetKinds', 'Optional', [v70.SubNetworkId, v70.AssetId32], v70.Type_544) as AssetKindsV70,
}

export interface AssetKindsV64  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key1: v64.SubNetworkId, key2: v64.AssetId32): Promise<(v64.Type_541 | undefined)>
    getMany(block: Block, keys: [v64.SubNetworkId, v64.AssetId32][]): Promise<(v64.Type_541 | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
    getPairs(block: Block, key1: v64.SubNetworkId): Promise<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
    getPairs(block: Block, key1: v64.SubNetworkId, key2: v64.AssetId32): Promise<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: v64.SubNetworkId): AsyncIterable<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: v64.SubNetworkId, key2: v64.AssetId32): AsyncIterable<[k: [v64.SubNetworkId, v64.AssetId32], v: (v64.Type_541 | undefined)][]>
}

export interface AssetKindsV70  {
    is(block: RuntimeCtx): boolean
    get(block: Block, key1: v70.SubNetworkId, key2: v70.AssetId32): Promise<(v70.Type_544 | undefined)>
    getMany(block: Block, keys: [v70.SubNetworkId, v70.AssetId32][]): Promise<(v70.Type_544 | undefined)[]>
    ...
    getPairs(block: Block): Promise<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
    getPairs(block: Block, key1: v70.SubNetworkId): Promise<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
    getPairs(block: Block, key1: v70.SubNetworkId, key2: v70.AssetId32): Promise<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block): AsyncIterable<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: v70.SubNetworkId): AsyncIterable<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
    getPairsPaged(pageSize: number, block: Block, key1: v70.SubNetworkId, key2: v70.AssetId32): AsyncIterable<[k: [v70.SubNetworkId, v70.AssetId32], v: (v70.Type_544 | undefined)][]>
}
