...
export type Type_439 = Type_439_Assets | Type_439_Balances | Type_439_BridgeMultisig | Type_439_CeresLiquidityLocker | Type_439_CeresStaking | Type_439_Council | Type_439_Currencies | Type_439_DEXAPI | Type_439_Democracy | Type_439_ElectionsPhragmen | Type_439_EthBridge | Type_439_Faucet | Type_439_Grandpa | Type_439_Identity | Type_439_ImOnline | Type_439_IrohaMigration | Type_439_LiquidityProxy | Type_439_MulticollateralBondingCurvePool | Type_439_Multisig | Type_439_Offences | Type_439_Permissions | Type_439_PoolXYK | Type_439_PswapDistribution | Type_439_Rewards | Type_439_Scheduler | Type_439_Session | Type_439_Staking | Type_439_Sudo | Type_439_System | Type_439_Technical | Type_439_TechnicalCommittee | Type_439_TechnicalMembership | Type_439_Tokens | Type_439_TradingPair | Type_439_Utility | Type_439_VestedRewards | Type_439_XSTPool | Type_439_XorFee

export interface Type_439_Assets {
    __kind: 'Assets'
    value: AssetsEvent
}

export interface Type_439_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_439_BridgeMultisig {
    __kind: 'BridgeMultisig'
    value: BridgeMultisigEvent
}

export interface Type_439_CeresLiquidityLocker {
    __kind: 'CeresLiquidityLocker'
    value: CeresLiquidityLockerEvent
}

export interface Type_439_CeresStaking {
    __kind: 'CeresStaking'
    value: CeresStakingEvent
}

export interface Type_439_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_439_Currencies {
    __kind: 'Currencies'
    value: CurrenciesEvent
}

export interface Type_439_DEXAPI {
    __kind: 'DEXAPI'
    value: DEXAPIEvent
}

export interface Type_439_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_439_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_439_EthBridge {
    __kind: 'EthBridge'
    value: EthBridgeEvent
}

export interface Type_439_Faucet {
    __kind: 'Faucet'
    value: FaucetEvent
}

export interface Type_439_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_439_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_439_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_439_IrohaMigration {
    __kind: 'IrohaMigration'
    value: IrohaMigrationEvent
}

export interface Type_439_LiquidityProxy {
    __kind: 'LiquidityProxy'
    value: LiquidityProxyEvent
}

export interface Type_439_MulticollateralBondingCurvePool {
    __kind: 'MulticollateralBondingCurvePool'
    value: MulticollateralBondingCurvePoolEvent
}

export interface Type_439_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_439_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_439_Permissions {
    __kind: 'Permissions'
    value: PermissionsEvent
}

export interface Type_439_PoolXYK {
    __kind: 'PoolXYK'
    value: PoolXYKEvent
}

export interface Type_439_PswapDistribution {
    __kind: 'PswapDistribution'
    value: PswapDistributionEvent
}

export interface Type_439_Rewards {
    __kind: 'Rewards'
    value: RewardsEvent
}

export interface Type_439_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_439_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_439_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_439_Sudo {
    __kind: 'Sudo'
    value: SudoEvent
}

export interface Type_439_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_439_Technical {
    __kind: 'Technical'
    value: TechnicalEvent
}

export interface Type_439_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_439_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_439_Tokens {
    __kind: 'Tokens'
    value: TokensEvent
}

export interface Type_439_TradingPair {
    __kind: 'TradingPair'
    value: TradingPairEvent
}

export interface Type_439_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_439_VestedRewards {
    __kind: 'VestedRewards'
    value: VestedRewardsEvent
}

export interface Type_439_XSTPool {
    __kind: 'XSTPool'
    value: XSTPoolEvent
}

export interface Type_439_XorFee {
    __kind: 'XorFee'
    value: XorFeeEvent
}
