...
export const Type_592: sts.Type<Type_592> = sts.struct(() => {
    return  {
        limit: sts.bigint(),
...
export type Type_215 = Type_215_Member | Type_215_Members | Type_215__Phantom
...
export type Type_214 = Type_214_Member | Type_214_Members | Type_214__Phantom
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestedRewardsCall = VestedRewardsCall_claim_crowdloan_rewards | VestedRewardsCall_claim_rewards
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_222
    maxValidatorCount: Type_222
    chillThreshold: Type_223
    minCommission: Type_224
}
...
export type Type_224 = Type_224_Noop | Type_224_Remove | Type_224_Set

export interface Type_224_Noop {
    __kind: 'Noop'
}

export interface Type_224_Remove {
    __kind: 'Remove'
}

export interface Type_224_Set {
    __kind: 'Set'
    value: Perbill
}

export type Type_223 = Type_223_Noop | Type_223_Remove | Type_223_Set

export interface Type_223_Noop {
    __kind: 'Noop'
}

export interface Type_223_Remove {
    __kind: 'Remove'
}

export interface Type_223_Set {
    __kind: 'Set'
    value: Percent
}

export type Type_222 = Type_222_Noop | Type_222_Remove | Type_222_Set
