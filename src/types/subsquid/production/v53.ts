...
export type Type_683 = Type_683_Requested | Type_683_Unrequested

export interface Type_683_Requested {
    __kind: 'Requested'
...
export interface Type_683_Unrequested {
    __kind: 'Unrequested'
    deposit: [AccountId32, bigint]
    len: number
}

export const Type_683: sts.Type<Type_683> = sts.closedEnum(() => {
    return  {
...
export type Type_224 = Type_224_Member | Type_224_Members | Type_224__Phantom
...
export type Type_223 = Type_223_Member | Type_223_Members | Type_223__Phantom

export interface Type_223_Member {
    __kind: 'Member'
    value: AccountId32
}

export interface Type_223_Members {
    __kind: 'Members'
    value: [number, number]
}

export interface Type_223__Phantom {
    __kind: '_Phantom'
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_229
    maxValidatorCount: Type_229
    chillThreshold: Type_230
    minCommission: Type_231
}
...
export type Type_230 = Type_230_Noop | Type_230_Remove | Type_230_Set

export interface Type_230_Noop {
    __kind: 'Noop'
}

export interface Type_230_Remove {
    __kind: 'Remove'
}

export interface Type_230_Set {
    __kind: 'Set'
    value: Percent
}

export type Type_229 = Type_229_Noop | Type_229_Remove | Type_229_Set

export interface Type_229_Noop {
    __kind: 'Noop'
}

export interface Type_229_Remove {
    __kind: 'Remove'
}

export interface Type_229_Set {
    __kind: 'Set'
    value: number
}
...
export type Type_137 = Type_137_ApplyExtrinsic | Type_137_Finalization | Type_137_Initialization

export interface Type_137_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_137_Finalization {
    __kind: 'Finalization'
}

export interface Type_137_Initialization {
...
export const Type_245: sts.Type<Type_245> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
