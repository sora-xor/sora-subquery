...
export type Type_637 = Type_637_Emergency | Type_637_Off | Type_637_Signed | Type_637_Unsigned

export interface Type_637_Emergency {
    __kind: 'Emergency'
}

export interface Type_637_Off {
    __kind: 'Off'
}

export interface Type_637_Signed {
    __kind: 'Signed'
}

export interface Type_637_Unsigned {
    __kind: 'Unsigned'
    value: [boolean, number]
}

export const Type_637: sts.Type<Type_637> = sts.closedEnum(() => {
    return  {
        Emergency: sts.unit(),
        Off: sts.unit(),
        Signed: sts.unit(),
...
export type Type_618 = Type_618_V1 | Type_618_V2

export interface Type_618_V1 {
    __kind: 'V1'
}

export interface Type_618_V2 {
    __kind: 'V2'
}

export const Type_618: sts.Type<Type_618> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export type Type_611 = Type_611_V1 | Type_611_V2

export interface Type_611_V1 {
    __kind: 'V1'
}

export interface Type_611_V2 {
    __kind: 'V2'
}

export const Type_611: sts.Type<Type_611> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export interface Type_581 {
    limit: bigint
    totalAvailable: bigint
    rewards: [RewardReason, bigint][]
}

export type RewardReason = RewardReason_BuyOnBondingCurve | RewardReason_Crowdloan | RewardReason_LiquidityProvisionFarming | RewardReason_MarketMakerVolume | RewardReason_Unspecified
...
export const Type_581: sts.Type<Type_581> = sts.struct(() => {
    return  {
        limit: sts.bigint(),
...
export type Type_544 = Type_544_V1

export interface Type_544_V1 {
    __kind: 'V1'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type VestedRewardsCall = VestedRewardsCall_claim_crowdloan_rewards | VestedRewardsCall_claim_rewards | VestedRewardsCall_set_asset_pair
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type LiquidityProxyCall = LiquidityProxyCall_disable_liquidity_source | LiquidityProxyCall_enable_liquidity_source | LiquidityProxyCall_swap | LiquidityProxyCall_swap_transfer
...
export interface Type_497 {
    amount: bigint
}

export const Type_497: sts.Type<Type_497> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
    }
})
...
export type Type_470 = Type_470_V1_0_0Ancient | Type_470_V2_0_0 | Type_470_V3_0_0 | Type_470_V4_0_0 | Type_470_V5_0_0 | Type_470_V6_0_0 | Type_470_V7_0_0 | Type_470_V8_0_0 | Type_470_V9_0_0

export interface Type_470_V1_0_0Ancient {
    __kind: 'V1_0_0Ancient'
}

export interface Type_470_V2_0_0 {
    __kind: 'V2_0_0'
}

export interface Type_470_V3_0_0 {
    __kind: 'V3_0_0'
}

export interface Type_470_V4_0_0 {
    __kind: 'V4_0_0'
}

export interface Type_470_V5_0_0 {
    __kind: 'V5_0_0'
}

export interface Type_470_V6_0_0 {
    __kind: 'V6_0_0'
}

export interface Type_470_V7_0_0 {
    __kind: 'V7_0_0'
}

export interface Type_470_V8_0_0 {
    __kind: 'V8_0_0'
}

export interface Type_470_V9_0_0 {
    __kind: 'V9_0_0'
}

export const Type_470: sts.Type<Type_470> = sts.closedEnum(() => {
    return  {
        V1_0_0Ancient: sts.unit(),
        V2_0_0: sts.unit(),
        V3_0_0: sts.unit(),
        V4_0_0: sts.unit(),
        V5_0_0: sts.unit(),
...
export type PredefinedAssetId = PredefinedAssetId_DAI | PredefinedAssetId_DOT | PredefinedAssetId_ETH | PredefinedAssetId_KSM | PredefinedAssetId_PSWAP | PredefinedAssetId_USDT | PredefinedAssetId_VAL | PredefinedAssetId_XOR | PredefinedAssetId_XST | PredefinedAssetId_XSTUSD
...
export type Type_178 = Type_178_V1Ancient | Type_178_V2

export interface Type_178_V1Ancient {
    __kind: 'V1Ancient'
}
...
export interface PswapDistributionEvent_FeesExchangeFailed {
    ...
    value: [number, AccountId32, AssetId32, bigint, AssetId32]
}
...
export interface DemeterFarmingPlatformEvent_DepositFeeChanged {
    ...
    value: [AccountId32, AssetId32, AssetId32, boolean, bigint]
}
...
export interface DemeterFarmingPlatformEvent_MultiplierChanged {
    ...
    value: [AccountId32, AssetId32, AssetId32, boolean, number]
}
...
export interface DemeterFarmingPlatformEvent_PoolAdded {
    __kind: 'PoolAdded'
    value: [AccountId32, AssetId32, AssetId32, boolean]
}
...
export interface DemeterFarmingPlatformEvent_RewardWithdrawn {
    ...
    value: [AccountId32, bigint, AssetId32, AssetId32, boolean]
}
...
export const PswapDistributionEvent: sts.Type<PswapDistributionEvent> = sts.closedEnum(() => {
    return  {
        ...
        FeesExchangeFailed: sts.tuple(() => [sts.number(), AccountId32, AssetId32, sts.bigint(), AssetId32]),
...
export const DemeterFarmingPlatformEvent: sts.Type<DemeterFarmingPlatformEvent> = sts.closedEnum(() => {
    return  {
        DepositFeeChanged: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean(), sts.bigint()]),
        Deposited: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean(), sts.bigint()]),
        InfoChanged: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean(), sts.bigint()]),
        MultiplierChanged: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean(), sts.number()]),
        PoolAdded: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean()]),
        PoolRemoved: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean()]),
        RewardWithdrawn: sts.tuple(() => [AccountId32, sts.bigint(), AssetId32, AssetId32, sts.boolean()]),
        TokenInfoChanged: sts.tuple(() => [AccountId32, AssetId32]),
        TokenRegistered: sts.tuple(() => [AccountId32, AssetId32]),
        TotalTokensChanged: sts.tuple(() => [AccountId32, AssetId32, AssetId32, sts.boolean(), sts.bigint()]),
        Withdrawn: sts.tuple(() => [AccountId32, sts.bigint(), AssetId32, AssetId32, sts.boolean()]),
    }
})
