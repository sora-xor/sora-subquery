...
export interface Type_54_ReferralSystem {
...
export type Type_428 = Type_428_Assets | Type_428_Balances | Type_428_BridgeMultisig | Type_428_CeresStaking | Type_428_Council | Type_428_Currencies | Type_428_DEXAPI | Type_428_Democracy | Type_428_ElectionsPhragmen | Type_428_EthBridge | Type_428_Grandpa | Type_428_Identity | Type_428_ImOnline | Type_428_IrohaMigration | Type_428_LiquidityProxy | Type_428_MulticollateralBondingCurvePool | Type_428_Multisig | Type_428_Offences | Type_428_Permissions | Type_428_PoolXYK | Type_428_PswapDistribution | Type_428_Rewards | Type_428_Scheduler | Type_428_Session | Type_428_Staking | Type_428_System | Type_428_Technical | Type_428_TechnicalCommittee | Type_428_TechnicalMembership | Type_428_Tokens | Type_428_TradingPair | Type_428_Utility | Type_428_VestedRewards | Type_428_XSTPool | Type_428_XorFee

export interface Type_428_Assets {
    __kind: 'Assets'
    value: AssetsEvent
}

export interface Type_428_Balances {
    __kind: 'Balances'
    value: BalancesEvent
}

export interface Type_428_BridgeMultisig {
    __kind: 'BridgeMultisig'
    value: BridgeMultisigEvent
}

export interface Type_428_CeresStaking {
    __kind: 'CeresStaking'
    value: CeresStakingEvent
}

export interface Type_428_Council {
    __kind: 'Council'
    value: CouncilEvent
}

export interface Type_428_Currencies {
    __kind: 'Currencies'
    value: CurrenciesEvent
}

export interface Type_428_DEXAPI {
    __kind: 'DEXAPI'
    value: DEXAPIEvent
}

export interface Type_428_Democracy {
    __kind: 'Democracy'
    value: DemocracyEvent
}

export interface Type_428_ElectionsPhragmen {
    __kind: 'ElectionsPhragmen'
    value: ElectionsPhragmenEvent
}

export interface Type_428_EthBridge {
    __kind: 'EthBridge'
    value: EthBridgeEvent
}

export interface Type_428_Grandpa {
    __kind: 'Grandpa'
    value: GrandpaEvent
}

export interface Type_428_Identity {
    __kind: 'Identity'
    value: IdentityEvent
}

export interface Type_428_ImOnline {
    __kind: 'ImOnline'
    value: ImOnlineEvent
}

export interface Type_428_IrohaMigration {
    __kind: 'IrohaMigration'
    value: IrohaMigrationEvent
}

export interface Type_428_LiquidityProxy {
    __kind: 'LiquidityProxy'
    value: LiquidityProxyEvent
}

export interface Type_428_MulticollateralBondingCurvePool {
    __kind: 'MulticollateralBondingCurvePool'
    value: MulticollateralBondingCurvePoolEvent
}

export interface Type_428_Multisig {
    __kind: 'Multisig'
    value: MultisigEvent
}

export interface Type_428_Offences {
    __kind: 'Offences'
    value: OffencesEvent
}

export interface Type_428_Permissions {
    __kind: 'Permissions'
    value: PermissionsEvent
}

export interface Type_428_PoolXYK {
    __kind: 'PoolXYK'
    value: PoolXYKEvent
}

export interface Type_428_PswapDistribution {
    __kind: 'PswapDistribution'
    value: PswapDistributionEvent
}

export interface Type_428_Rewards {
    __kind: 'Rewards'
    value: RewardsEvent
}

export interface Type_428_Scheduler {
    __kind: 'Scheduler'
    value: SchedulerEvent
}

export interface Type_428_Session {
    __kind: 'Session'
    value: SessionEvent
}

export interface Type_428_Staking {
    __kind: 'Staking'
    value: StakingEvent
}

export interface Type_428_System {
    __kind: 'System'
    value: SystemEvent
}

export interface Type_428_Technical {
    __kind: 'Technical'
    value: TechnicalEvent
}

export interface Type_428_TechnicalCommittee {
    __kind: 'TechnicalCommittee'
    value: TechnicalCommitteeEvent
}

export interface Type_428_TechnicalMembership {
    __kind: 'TechnicalMembership'
    value: TechnicalMembershipEvent
}

export interface Type_428_Tokens {
    __kind: 'Tokens'
    value: TokensEvent
}

export interface Type_428_TradingPair {
    __kind: 'TradingPair'
    value: TradingPairEvent
}

export interface Type_428_Utility {
    __kind: 'Utility'
    value: UtilityEvent
}

export interface Type_428_VestedRewards {
    __kind: 'VestedRewards'
    value: VestedRewardsEvent
}

export interface Type_428_XSTPool {
    __kind: 'XSTPool'
    value: XSTPoolEvent
}

export interface Type_428_XorFee {
    __kind: 'XorFee'
    value: XorFeeEvent
}
