...
export type Type_609 = Type_609_Sidechain | Type_609_Thischain

export interface Type_609_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_609_Thischain {
    __kind: 'Thischain'
}
...
export interface StoredHeader {
    submitter?: (AccountId32 | undefined)
    header: Type_556
    totalDifficulty: bigint
    finalized: boolean
}

export interface Type_556 {
    parentHash: H256
    timestamp: bigint
    number: bigint
    author: H160
...
export const StoredHeader: sts.Type<StoredHeader> = sts.struct(() => {
    return  {
        submitter: sts.option(() => AccountId32),
        header: Type_556,
        totalDifficulty: sts.bigint(),
        finalized: sts.boolean(),
    }
})
...
export interface PruningRange {
    oldestUnprunedBlock: bigint
    oldestBlockToKeep: bigint
}

export const PruningRange: sts.Type<PruningRange> = sts.struct(() => {
    return  {
        oldestUnprunedBlock: sts.bigint(),
        oldestBlockToKeep: sts.bigint(),
    }
})
...
export const LimitOrder: sts.Type<LimitOrder> = sts.struct(() => {
    return  {
        id: sts.bigint(),
        owner: AccountId32,
        side: PriceVariant,
...
export interface OrderBook {
    ...
    lastOrderId: bigint
    tickSize: BalanceUnit
    stepLotSize: BalanceUnit
    minLotSize: BalanceUnit
    maxLotSize: BalanceUnit
    techStatus: OrderBookTechStatus
}

export type OrderBookTechStatus = OrderBookTechStatus_Ready | OrderBookTechStatus_Updating

export interface OrderBookTechStatus_Ready {
    __kind: 'Ready'
}

export interface OrderBookTechStatus_Updating {
    __kind: 'Updating'
}
...
export const OrderBook: sts.Type<OrderBook> = sts.struct(() => {
    return  {
        orderBookId: OrderBookId,
        status: OrderBookStatus,
        lastOrderId: sts.bigint(),
        tickSize: BalanceUnit,
        stepLotSize: BalanceUnit,
        minLotSize: BalanceUnit,
        maxLotSize: BalanceUnit,
...
export const OrderBookTechStatus: sts.Type<OrderBookTechStatus> = sts.closedEnum(() => {
    return  {
        Ready: sts.unit(),
        Updating: sts.unit(),
    }
...
export type Type_837 = Type_837_Requested | Type_837_Unrequested

export interface Type_837_Requested {
    __kind: 'Requested'
...
export interface Type_837_Unrequested {
    __kind: 'Unrequested'
    deposit: [AccountId32, bigint]
    len: number
}

export const Type_837: sts.Type<Type_837> = sts.closedEnum(() => {
    return  {
...
export type Type_835 = Type_835_V1 | Type_835_V2

export interface Type_835_V1 {
    __kind: 'V1'
}

export interface Type_835_V2 {
    __kind: 'V2'
}

export const Type_835: sts.Type<Type_835> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export interface BandRate {
    ...
    requestId: bigint
    dynamicFee: FixedPoint
}

export const BandRate: sts.Type<BandRate> = sts.struct(() => {
    return  {
        value: sts.bigint(),
        lastUpdated: sts.bigint(),
        lastUpdatedBlock: sts.number(),
...
export type Type_809 = Type_809_V1 | Type_809_V2

export interface Type_809_V1 {
    __kind: 'V1'
}

export interface Type_809_V2 {
    __kind: 'V2'
}

export const Type_809: sts.Type<Type_809> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export const PoolData: sts.Type<PoolData> = sts.struct(() => {
    return  {
        multiplier: sts.number(),
        depositFee: sts.bigint(),
        isCore: sts.boolean(),
        isFarm: sts.boolean(),
        totalTokensInPool: sts.bigint(),
        rewards: sts.bigint(),
        rewardsToBeDistributed: sts.bigint(),
...
export const UserInfo: sts.Type<UserInfo> = sts.struct(() => {
    return  {
        baseAsset: AssetId32,
        poolAsset: AssetId32,
        rewardAsset: AssetId32,
...
export const TokenInfo: sts.Type<TokenInfo> = sts.struct(() => {
    return  {
        farmsTotalMultiplier: sts.number(),
        stakingTotalMultiplier: sts.number(),
...
export const ContributionInfo: sts.Type<ContributionInfo> = sts.struct(() => {
    return  {
        fundsContributed: sts.bigint(),
        tokensBought: sts.bigint(),
        tokensClaimed: sts.bigint(),
...
export type Type_796 = Type_796_V1 | Type_796_V2 | Type_796_V3

export interface Type_796_V1 {
    __kind: 'V1'
}

export interface Type_796_V2 {
    __kind: 'V2'
}

export interface Type_796_V3 {
    __kind: 'V3'
}

export const Type_796: sts.Type<Type_796> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
        V3: sts.unit(),
...
export type Type_789 = Type_789_V1 | Type_789_V2

export interface Type_789_V1 {
    __kind: 'V1'
}

export interface Type_789_V2 {
    __kind: 'V2'
}

export const Type_789: sts.Type<Type_789> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export const StorageVersion: sts.Type<StorageVersion> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export const StakingInfo: sts.Type<StakingInfo> = sts.struct(() => {
    return  {
        deposited: sts.bigint(),
        rewards: sts.bigint(),
    }
})

export interface AggregatedPriceInfo {
    buy: PriceInfo
    sell: PriceInfo
}
...
export const AggregatedPriceInfo: sts.Type<AggregatedPriceInfo> = sts.struct(() => {
    return  {
        buy: PriceInfo,
        sell: PriceInfo,
    }
...
export const PriceInfo: sts.Type<PriceInfo> = sts.struct(() => {
    return  {
        ...
        averagePrice: sts.bigint(),
        needsUpdate: sts.boolean(),
        lastSpotPrice: sts.bigint(),
    }
})
...
export interface CrowdloanUserInfo {
    contribution: bigint
    rewarded: [AssetId32, bigint][]
}

export const CrowdloanUserInfo: sts.Type<CrowdloanUserInfo> = sts.struct(() => {
    return  {
        contribution: sts.bigint(),
        rewarded: sts.array(() => sts.tuple(() => [AssetId32, sts.bigint()])),
    }
})

export type CrowdloanTag = Bytes

export interface CrowdloanInfo {
...
export const CrowdloanInfo: sts.Type<CrowdloanInfo> = sts.struct(() => {
    return  {
        totalContribution: sts.bigint(),
...
export const Type_759: sts.Type<Type_759> = sts.struct(() => {
    return  {
        limit: sts.bigint(),
        totalAvailable: sts.bigint(),
        rewards: sts.array(() => sts.tuple(() => [RewardReason, sts.bigint()])),
    }
})
...
export type Type_288 = Type_288_Member | Type_288_Members | Type_288__Phantom
...
export const Type_741: sts.Type<Type_741> = sts.struct(() => {
    return  {
        when: Timepoint,
        deposit: sts.bigint(),
        depositor: AccountId32,
...
export type RequestStatus = RequestStatus_ApprovalsReady | RequestStatus_Broken | RequestStatus_Done | RequestStatus_Failed | RequestStatus_Frozen | RequestStatus_Pending
...
export const RequestStatus: sts.Type<RequestStatus> = sts.closedEnum(() => {
    return  {
        ...
        Broken: sts.tuple(() => [DispatchError, DispatchError]),
        Done: sts.unit(),
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_299
    maxValidatorCount: Type_299
    chillThreshold: Type_300
    minCommission: Type_301
}
...
export interface DEXInfo {
    baseAssetId: AssetId32
    syntheticBaseAssetId: AssetId32
    isPublic: boolean
}
...
export type AssetRecordArg = AssetRecordArg_AssetRecordAssetId | AssetRecordArg_Extra | AssetRecordArg_GenericH256 | AssetRecordArg_GenericH512 | AssetRecordArg_GenericI32 | AssetRecordArg_GenericU128 | AssetRecordArg_GenericU64 | AssetRecordArg_GenericU8x32 | AssetRecordArg_LeafAssetId
...
export type AssetIdExtraAssetRecordArg = AssetIdExtraAssetRecordArg_AccountId | AssetIdExtraAssetRecordArg_DEXId | AssetIdExtraAssetRecordArg_LstId
...
export const AssetRecord: sts.Type<AssetRecord> = sts.closedEnum(() => {
    return  {
        Arity0: sts.unit(),
        Arity1: AssetRecordArg,
        Arity2: sts.tuple(() => [AssetRecordArg, AssetRecordArg]),
        Arity3: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity4: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity5: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity6: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity7: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity8: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
        Arity9: sts.tuple(() => [AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg, AssetRecordArg]),
    }
})

export const AssetRecordArg: sts.Type<AssetRecordArg> = sts.closedEnum(() => {
    return  {
        AssetRecordAssetId: AssetId32,
        Extra: AssetIdExtraAssetRecordArg,
        GenericH256: H256,
        GenericH512: H512,
        GenericI32: sts.number(),
        GenericU128: sts.bigint(),
        GenericU64: sts.bigint(),
        GenericU8x32: sts.bytes(),
        LeafAssetId: AssetId32,
    }
})

export const H512 = sts.bytes()

export const AssetIdExtraAssetRecordArg: sts.Type<AssetIdExtraAssetRecordArg> = sts.closedEnum(() => {
    return  {
        AccountId: sts.bytes(),
        DEXId: sts.number(),
        LstId: LiquiditySourceType,
    }
})
...
export interface Type_677 {
    amount: bigint
}

export const Type_677: sts.Type<Type_677> = sts.struct(() => {
    return  {
        amount: sts.bigint(),
    }
})
...
export const DurationWrapper: sts.Type<DurationWrapper> = sts.struct(() => {
    return  {
        secs: sts.bigint(),
        nanos: sts.number(),
    }
...
export type Type_204 = Type_204_ApplyExtrinsic | Type_204_Finalization | Type_204_Initialization

export interface Type_204_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_204_Finalization {
    __kind: 'Finalization'
}

export interface Type_204_Initialization {
...
export const Type_607: sts.Type<Type_607> = sts.struct(() => {
    return  {
        digest: AuxiliaryDigest,
...
export const Type_556: sts.Type<Type_556> = sts.struct(() => {
    return  {
        parentHash: H256,
...
export const Type_306: sts.Type<Type_306> = sts.struct(() => {
    return  {
        setId: sts.bigint(),
        equivocation: Equivocation,
    }
...
export const Type_313: sts.Type<Type_313> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_287,
        Dispatch: Type_289,
        SubstrateDispatch: Type_293,
        TechnicalCommittee: Type_288,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_293: sts.Type<Type_293> = sts.struct(() => {
    return  {
        origin: Type_294,
    }
})
...
export const Type_289: sts.Type<Type_289> = sts.struct(() => {
    return  {
        origin: CallOriginOutput,
    }
})
