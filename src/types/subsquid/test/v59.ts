 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XSTPoolCall = XSTPoolCall_disable_synthetic_asset | XSTPoolCall_enable_synthetic_asset | XSTPoolCall_register_synthetic_asset | XSTPoolCall_set_reference_asset | XSTPoolCall_set_synthetic_asset_fee | XSTPoolCall_set_synthetic_base_asset_floor_price
...
export type Type_594 = Type_594_Sidechain | Type_594_Thischain

export interface Type_594_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_594_Thischain {
    __kind: 'Thischain'
}
...
export interface StakingCall_set_staking_configs {
    ...
    maxNominatorCount: Type_289
    maxValidatorCount: Type_289
    chillThreshold: Type_290
    minCommission: Type_291
}
 ...
 */
export type XSTPoolEvent = XSTPoolEvent_ReferenceAssetChanged | XSTPoolEvent_SyntheticAssetDisabled | XSTPoolEvent_SyntheticAssetEnabled | XSTPoolEvent_SyntheticAssetFeeChanged | XSTPoolEvent_SyntheticBaseAssetFloorPriceChanged
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_277,
        Dispatch: Type_279,
        SubstrateDispatch: Type_283,
        TechnicalCommittee: Type_278,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_575: sts.Type<Type_575> = sts.struct(() => {
    return  {
        order: sts.bigint(),
...
export const Type_578: sts.Type<Type_578> = sts.struct(() => {
    return  {
...
export const Type_583: sts.Type<Type_583> = sts.struct(() => {
    return  {
        nonce: sts.bigint(),
...
export const Type_303: sts.Type<Type_303> = sts.struct(() => {
    return  {
        roundNumber: sts.bigint(),
        identity: Public,
...
export const Type_541: sts.Type<Type_541> = sts.struct(() => {
    return  {
        parentHash: H256,
