...
export type Type_596 = Type_596_Sidechain | Type_596_Thischain

export interface Type_596_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_596_Thischain {
    __kind: 'Thischain'
}
...
export const Type_543: sts.Type<Type_543> = sts.struct(() => {
    return  {
        parentHash: H256,
