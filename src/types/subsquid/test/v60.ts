...
export type Type_595 = Type_595_Sidechain | Type_595_Thischain

export interface Type_595_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_595_Thischain {
    __kind: 'Thischain'
}
...
export const Type_542: sts.Type<Type_542> = sts.struct(() => {
    return  {
        parentHash: H256,
