...
export type Type_579 = Type_579_Sidechain | Type_579_Thischain

export interface Type_579_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_579_Thischain {
    __kind: 'Thischain'
}
...
export type Type_192 = Type_192_ApplyExtrinsic | Type_192_Finalization | Type_192_Initialization

export interface Type_192_ApplyExtrinsic {
    __kind: 'ApplyExtrinsic'
    value: number
}

export interface Type_192_Finalization {
    __kind: 'Finalization'
}

export interface Type_192_Initialization {
...
export const Type_577: sts.Type<Type_577> = sts.struct(() => {
    return  {
        digest: AuxiliaryDigest,
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_275,
        Dispatch: Type_277,
        SubstrateDispatch: Type_281,
        TechnicalCommittee: Type_276,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_281: sts.Type<Type_281> = sts.struct(() => {
    return  {
        origin: Type_282,
    }
})
...
export const Type_277: sts.Type<Type_277> = sts.struct(() => {
    return  {
        origin: CallOriginOutput,
    }
})
...
export const Type_579: sts.Type<Type_579> = sts.closedEnum(() => {
    return  {
        Sidechain: sts.unit(),
        Thischain: sts.unit(),
    }
