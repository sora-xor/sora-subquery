...
export const ParachainMessage: sts.Type<ParachainMessage> = sts.struct(() => {
    return  {
        payload: sts.bytes(),
        nonce: sts.bigint(),
...
export type Type_568 = Type_568_Sidechain | Type_568_Thischain
...
export const Type_802: sts.Type<Type_802> = sts.struct(() => {
    return  {
...
export type MessageStatus = MessageStatus_Committed | MessageStatus_Done | MessageStatus_Failed | MessageStatus_InQueue | MessageStatus_Refunded
...
export type GenericAccount = GenericAccount_EVM | GenericAccount_Parachain | GenericAccount_Sora | GenericAccount_Unknown
...
export const BridgeRequest: sts.Type<BridgeRequest> = sts.struct(() => {
    return  {
        ...
        endTimestamp: sts.option(() => sts.bigint()),
        direction: MessageDirection,
    }
})
...
export type Type_783 = Type_783_Requested | Type_783_Unrequested

export interface Type_783_Requested {
    __kind: 'Requested'
...
export interface Type_783_Unrequested {
    __kind: 'Unrequested'
    deposit: [AccountId32, bigint]
    len: number
}

export const Type_783: sts.Type<Type_783> = sts.closedEnum(() => {
    return  {
...
export type Type_263 = Type_263_Member | Type_263_Members | Type_263__Phantom
...
export type Call = Call_Assets | Call_Babe | Call_BagsList | Call_Band | Call_BeefyLightClient | Call_BridgeInboundChannel | Call_BridgeMultisig | Call_CeresGovernancePlatform | Call_CeresLaunchpad | Call_CeresLiquidityLocker | Call_CeresStaking | Call_CeresTokenLocker | Call_Council | Call_DEXAPI | Call_DemeterFarmingPlatform | Call_Democracy | Call_ERC20App | Call_ElectionProviderMultiPhase | Call_ElectionsPhragmen | Call_EthApp | Call_EthBridge | Call_EthereumLightClient | Call_EvmBridgeProxy | Call_Faucet | Call_Grandpa | Call_HermesGovernancePlatform | Call_Identity | Call_ImOnline | Call_IrohaMigration | Call_LiquidityProxy | Call_MigrationApp | Call_MulticollateralBondingCurvePool | Call_Multisig | Call_OracleProxy | Call_Permissions | Call_PoolXYK | Call_Preimage | Call_PswapDistribution | Call_Referrals | Call_Rewards | Call_Scheduler | Call_Session | Call_Staking | Call_SubstrateBridgeApp | Call_SubstrateBridgeInboundChannel | Call_Sudo | Call_System | Call_Technical | Call_TechnicalCommittee | Call_TechnicalMembership | Call_Timestamp | Call_TradingPair | Call_Utility | Call_VestedRewards | Call_XSTPool | Call_XorFee
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SubstrateBridgeInboundChannelCall = SubstrateBridgeInboundChannelCall_set_reward_fraction | SubstrateBridgeInboundChannelCall_submit
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type SubstrateBridgeAppCall = SubstrateBridgeAppCall_burn | SubstrateBridgeAppCall_finalize_asset_registration | SubstrateBridgeAppCall_mint | SubstrateBridgeAppCall_register_sidechain_asset | SubstrateBridgeAppCall_register_thischain_asset
...
export type Type_274 = Type_274_Noop | Type_274_Remove | Type_274_Set
...
export type Type_273 = Type_273_Noop | Type_273_Remove | Type_273_Set
...
export interface MigrationAppCall_migrate_sidechain {
    ...
    networkId: bigint
    sidechainAssets: [AssetId32, H160][]
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type BridgeInboundChannelCall = BridgeInboundChannelCall_message_dispatched | BridgeInboundChannelCall_register_channel | BridgeInboundChannelCall_set_reward_fraction | BridgeInboundChannelCall_submit
...
export type Event = Event_Assets | Event_BagsList | Event_Balances | Event_Band | Event_BeefyLightClient | Event_BridgeInboundChannel | Event_BridgeMultisig | Event_BridgeOutboundChannel | Event_CeresGovernancePlatform | Event_CeresLaunchpad | Event_CeresLiquidityLocker | Event_CeresStaking | Event_CeresTokenLocker | Event_Council | Event_DemeterFarmingPlatform | Event_Democracy | Event_Dispatch | Event_ERC20App | Event_ElectionProviderMultiPhase | Event_ElectionsPhragmen | Event_EthApp | Event_EthBridge | Event_EthereumLightClient | Event_EvmBridgeProxy | Event_Faucet | Event_Grandpa | Event_HermesGovernancePlatform | Event_Identity | Event_ImOnline | Event_IrohaMigration | Event_LeafProvider | Event_LiquidityProxy | Event_MigrationApp | Event_MulticollateralBondingCurvePool | Event_Multisig | Event_Offences | Event_OracleProxy | Event_Permissions | Event_PoolXYK | Event_Preimage | Event_PriceTools | Event_PswapDistribution | Event_Rewards | Event_Scheduler | Event_Session | Event_Staking | Event_SubstrateBridgeApp | Event_SubstrateBridgeInboundChannel | Event_SubstrateBridgeOutboundChannel | Event_SubstrateDispatch | Event_Sudo | Event_System | Event_Technical | Event_TechnicalCommittee | Event_TechnicalMembership | Event_Tokens | Event_TradingPair | Event_TransactionPayment | Event_Utility | Event_VestedRewards | Event_XSTPool | Event_XorFee
 ...
 * Events for the ETH module.
 */
export type EvmBridgeProxyEvent = EvmBridgeProxyEvent_RefundFailed | EvmBridgeProxyEvent_RequestStatusUpdate
...
export const Event: sts.Type<Event> = sts.closedEnum(() => {
    return  {
        ...
        EvmBridgeProxy: EvmBridgeProxyEvent,
        Faucet: FaucetEvent,
...
export const SubstrateBridgeOutboundChannelEvent: sts.Type<SubstrateBridgeOutboundChannelEvent> = sts.closedEnum(() => {
    return  {
        MessageAccepted: sts.tuple(() => [SubNetworkId, sts.bigint()]),
    }
})
 ...
 * Events for the ETH module.
 */
export const EvmBridgeProxyEvent: sts.Type<EvmBridgeProxyEvent> = sts.closedEnum(() => {
    return  {
        RefundFailed: H256,
...
export const BridgeOutboundChannelEvent: sts.Type<BridgeOutboundChannelEvent> = sts.closedEnum(() => {
    return  {
        MessageAccepted: sts.tuple(() => [sts.bigint(), sts.bigint()]),
    }
})
...
export const ProvedSubstrateBridgeMessage: sts.Type<ProvedSubstrateBridgeMessage> = sts.struct(() => {
    return  {
        message: sts.array(() => ParachainMessage),
        proof: Type_559,
        leaf: MmrLeaf,
        digest: AuxiliaryDigest,
    }
...
export const Type_559: sts.Type<Type_559> = sts.struct(() => {
    return  {
        order: sts.bigint(),
...
export const OriginCaller: sts.Type<OriginCaller> = sts.closedEnum(() => {
    return  {
        Council: Type_262,
        Dispatch: Type_264,
        SubstrateDispatch: Type_267,
        TechnicalCommittee: Type_263,
        Void: Void,
        system: RawOrigin,
    }
})
...
export const Type_267: sts.Type<Type_267> = sts.struct(() => {
    return  {
        origin: Type_268,
    }
})

export const Type_268: sts.Type<Type_268> = sts.struct(() => {
    return  {
        networkId: SubNetworkId,
        messageId: H256,
        timestamp: sts.bigint(),
...
export const Call: sts.Type<Call> = sts.closedEnum(() => {
    return  {
        ...
        EvmBridgeProxy: EvmBridgeProxyCall,
        Faucet: FaucetCall,
        Grandpa: GrandpaCall,
...
export const MigrationAppCall: sts.Type<MigrationAppCall> = sts.closedEnum(() => {
    return  {
        migrate_erc20: sts.enumStruct({
            networkId: sts.bigint(),
            erc20Assets: sts.array(() => sts.tuple(() => [AssetId32, H160])),
        }),
        ...
        migrate_sidechain: sts.enumStruct({
            networkId: sts.bigint(),
            sidechainAssets: sts.array(() => sts.tuple(() => [AssetId32, H160])),
        }),
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export const EvmBridgeProxyCall: sts.Type<EvmBridgeProxyCall> = sts.closedEnum(() => {
    return  {
        burn: sts.enumStruct({
            networkId: GenericNetworkId,
            assetId: AssetId32,
...
export const BridgeInboundChannelCall: sts.Type<BridgeInboundChannelCall> = sts.closedEnum(() => {
    return  {
        message_dispatched: sts.enumStruct({
            networkId: sts.bigint(),
            message: Message,
        }),
