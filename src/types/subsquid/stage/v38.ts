...
export type VestedRewardsCall = VestedRewardsCall_claim_crowdloan_rewards | VestedRewardsCall_claim_rewards | VestedRewardsCall_inject_market_makers | VestedRewardsCall_set_asset_pair
...
export type RewardsCall = RewardsCall_add_umi_nft_receivers | RewardsCall_claim | RewardsCall_finalize_storage_migration
...
export interface EthBridgeCall_remove_peer {
    __kind: 'remove_peer'
    accountId: AccountId
    peerAddress?: (EthAddress | undefined)
    networkId: BridgeNetworkId
}
...
export interface DemeterFarmingPlatformEvent_DepositFeeChanged {
    ...
    value: [AccountId, AssetId, AssetId, boolean, Balance]
}
...
export interface DemeterFarmingPlatformEvent_MultiplierChanged {
    ...
    value: [AccountId, AssetId, AssetId, boolean, number]
}
...
export interface DemeterFarmingPlatformEvent_PoolAdded {
    __kind: 'PoolAdded'
    value: [AccountId, AssetId, AssetId, boolean]
}
...
export interface DemeterFarmingPlatformEvent_RewardWithdrawn {
    ...
    value: [AccountId, Balance, AssetId, AssetId, boolean]
}
...
export interface CeresLiquidityLockerEvent_Locked {
    __kind: 'Locked'
    value: [AccountId, Balance, Moment]
}
...
export interface CeresGovernancePlatformEvent_Created {
    __kind: 'Created'
    value: [AccountId, number, Moment, Moment]
}
...
export const DemeterFarmingPlatformEvent: sts.Type<DemeterFarmingPlatformEvent> = sts.closedEnum(() => {
    return  {
        ...
        Deposited: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean(), Balance]),
        InfoChanged: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean(), Balance]),
        MultiplierChanged: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean(), sts.number()]),
        PoolAdded: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean()]),
        PoolRemoved: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean()]),
        RewardWithdrawn: sts.tuple(() => [AccountId, Balance, AssetId, AssetId, sts.boolean()]),
        TokenInfoChanged: sts.tuple(() => [AccountId, AssetId]),
        TokenRegistered: sts.tuple(() => [AccountId, AssetId]),
        TotalTokensChanged: sts.tuple(() => [AccountId, AssetId, AssetId, sts.boolean(), Balance]),
        Withdrawn: sts.tuple(() => [AccountId, Balance, AssetId, AssetId, sts.boolean()]),
    }
})
...
export const CeresLiquidityLockerEvent: sts.Type<CeresLiquidityLockerEvent> = sts.closedEnum(() => {
    return  {
        Locked: sts.tuple(() => [AccountId, Balance, Moment]),
    }
})
...
export const CeresLaunchpadEvent: sts.Type<CeresLaunchpadEvent> = sts.closedEnum(() => {
    return  {
        ...
        RemovedWhitelistedContributor: AccountId,
        RemovedWhitelistedIloOrganizer: AccountId,
        WhitelistedContributor: AccountId,
        WhitelistedIloOrganizer: AccountId,
    }
})

export const CeresGovernancePlatformEvent: sts.Type<CeresGovernancePlatformEvent> = sts.closedEnum(() => {
    return  {
        Created: sts.tuple(() => [AccountId, sts.number(), Moment, Moment]),
...
export const RewardsCall: sts.Type<RewardsCall> = sts.closedEnum(() => {
    return  {
        add_umi_nft_receivers: sts.enumStruct({
            receivers: sts.array(() => EthAddress),
        }),
        claim: sts.enumStruct({
            signature: sts.bytes(),
        }),
        finalize_storage_migration: sts.enumStruct({
            amounts: sts.array(() => sts.tuple(() => [EthAddress, Balance])),
        }),
    }
})
...
export const EthBridgeCall: sts.Type<EthBridgeCall> = sts.closedEnum(() => {
    return  {
        ...
        remove_peer: sts.enumStruct({
            accountId: AccountId,
            peerAddress: sts.option(() => EthAddress),
            networkId: BridgeNetworkId,
        }),
