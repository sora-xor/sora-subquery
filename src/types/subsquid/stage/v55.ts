...
export type Type_795 = Type_795_V1 | Type_795_V2

export interface Type_795_V1 {
    __kind: 'V1'
}

export interface Type_795_V2 {
    __kind: 'V2'
}

export const Type_795: sts.Type<Type_795> = sts.closedEnum(() => {
    return  {
        V1: sts.unit(),
        V2: sts.unit(),
    }
...
export type Type_582 = Type_582_Sidechain | Type_582_Thischain

export interface Type_582_Sidechain {
    __kind: 'Sidechain'
}

export interface Type_582_Thischain {
    __kind: 'Thischain'
}
...
export const Type_580: sts.Type<Type_580> = sts.struct(() => {
    return  {
        digest: AuxiliaryDigest,
...
export const Type_582: sts.Type<Type_582> = sts.closedEnum(() => {
    return  {
        Sidechain: sts.unit(),
        Thischain: sts.unit(),
    }
