...
export type Type_738 = Type_738_V1 | Type_738_V2 | Type_738_V3

export interface Type_738_V1 {
    __kind: 'V1'
}

export interface Type_738_V2 {
    __kind: 'V2'
}

export interface Type_738_V3 {
    __kind: 'V3'
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type QAToolsCall = QAToolsCall_add_to_whitelist | QAToolsCall_order_book_create_and_fill_batch | QAToolsCall_order_book_create_empty_batch | QAToolsCall_remove_from_whitelist

/**
 * Add the account to the list of allowed callers.
 */
export interface QAToolsCall_add_to_whitelist {
...
export interface QAToolsCall_order_book_create_and_fill_batch {
    ...
    fillSettings: [OrderBookId, OrderBookFillSettings][]
}
 ...
 */
export interface QAToolsCall_remove_from_whitelist {
...
export const QAToolsCall: sts.Type<QAToolsCall> = sts.closedEnum(() => {
    return  {
        ...
        order_book_create_and_fill_batch: sts.enumStruct({
            bidsOwner: AccountId32,
            asksOwner: AccountId32,
            fillSettings: sts.array(() => sts.tuple(() => [OrderBookId, OrderBookFillSettings])),
        }),
