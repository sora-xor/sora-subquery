...
export const Rate: sts.Type<Rate> = sts.struct(() => {
    return  {
        value: sts.bigint(),
...
export type Type_198 = Type_198_Member | Type_198_Members | Type_198__Phantom
...
export type Type_197 = Type_197_Member | Type_197_Members | Type_197__Phantom
...
export const BandEvent: sts.Type<BandEvent> = sts.closedEnum(() => {
    return  {
        ...
        SymbolsRelayed: sts.array(() => sts.string()),
    }
})
