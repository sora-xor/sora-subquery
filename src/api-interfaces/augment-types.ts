...
import type { Amount, AmountOf, AssetId32, AssetIdOf, AssetName, AssetSymbol, BalancePrecision, BasisPoints, ChargeFeeInfo, CurrencyId, CurrencyIdOf, DEXId, DEXIdOf, DEXInfo, DispatchErrorWithPostInfoTPostDispatchInfo, DispatchResultWithPostInfo, DistributionAccounts, Duration, Farm, FarmId, Farmer, FilterMode, Fixed, HolderId, LiquiditySourceType, MarketMakerInfo, Mode, MultiCurrencyBalanceOf, MultisigAccount, OracleKey, OwnerId, Permission, PermissionId, PostDispatchInfo, PredefinedAssetId, PriceInfo, Public, QuoteAmount, QuoteWithDesiredInput, QuoteWithDesiredOutput, RewardInfo, RewardReason, Scope, SmoothPriceState, StorageVersion, SwapAction, SwapAmount, SwapOutcome, SwapOutcomeInfo, SwapVariant, SwapWithDesiredInput, SwapWithDesiredOutput, TechAccountId, TechAmount, TechAssetId, TechBalance, TechPurpose, TechTradingPair, TradingPair, ValidationFunction } from 'sora/api-interfaces/sora';
...
declare module '@polkadot/types/types/registry' {
  export interface InterfaceTypes {
    ...
    'Compact<AssetIdOf>': Compact<AssetIdOf>;
    ...
    'Compact<BalancePrecision>': Compact<BalancePrecision>;
    'Compact<BasisPoints>': Compact<BasisPoints>;
    ...
    'Compact<BridgeNetworkId>': Compact<BridgeNetworkId>;
    ...
    'Compact<PermissionId>': Compact<PermissionId>;
    ...
    'Compact<TechBalance>': Compact<TechBalance>;
    ...
    'Option<AssetIdOf>': Option<AssetIdOf>;
    ...
    'Option<BalancePrecision>': Option<BalancePrecision>;
    ...
    'Option<BridgeNetworkId>': Option<BridgeNetworkId>;
    'Option<BridgeStatus>': Option<BridgeStatus>;
    'Option<BridgeTimepoint>': Option<BridgeTimepoint>;
    ...
    'Option<EthPeersSync>': Option<EthPeersSync>;
    ...
    'Option<Farmer>': Option<Farmer>;
    'Option<FarmId>': Option<FarmId>;
    ...
    'Option<FixedBytes>': Option<FixedBytes>;
    ...
    'Option<HolderId>': Option<HolderId>;
    ...
    'Option<MarketMakerInfo>': Option<MarketMakerInfo>;
    ...
    'Option<MultiChainHeight>': Option<MultiChainHeight>;
    'Option<MultiCurrencyBalance>': Option<MultiCurrencyBalance>;
    'Option<MultiCurrencyBalanceOf>': Option<MultiCurrencyBalanceOf>;
    ...
    'Option<MultisigAccount>': Option<MultisigAccount>;
    ...
    'Option<OffchainRequest>': Option<OffchainRequest>;
    ...
    'Option<OutgoingMigrate>': Option<OutgoingMigrate>;
    'Option<OutgoingMigrateEncoded>': Option<OutgoingMigrateEncoded>;
    ...
    'Option<OutgoingTransfer>': Option<OutgoingTransfer>;
    'Option<OutgoingTransferEncoded>': Option<OutgoingTransferEncoded>;
    'Option<OverweightIndex>': Option<OverweightIndex>;
    'Option<Owner>': Option<Owner>;
    'Option<OwnerId>': Option<OwnerId>;
    ...
    'Option<PendingMultisigAccount>': Option<PendingMultisigAccount>;
    ...
    'Option<PermissionId>': Option<PermissionId>;
    ...
    'Option<QuoteWithDesiredInput>': Option<QuoteWithDesiredInput>;
    'Option<QuoteWithDesiredOutput>': Option<QuoteWithDesiredOutput>;
    ...
    'Option<SignatureParams>': Option<SignatureParams>;
    ...
    'Option<SmoothPriceState>': Option<SmoothPriceState>;
    ...
    'Option<SwapAmount>': Option<SwapAmount>;
    'Option<SwapOutcome>': Option<SwapOutcome>;
    'Option<SwapOutcomeInfo>': Option<SwapOutcomeInfo>;
    'Option<SwapVariant>': Option<SwapVariant>;
    'Option<SwapWithDesiredInput>': Option<SwapWithDesiredInput>;
    'Option<SwapWithDesiredOutput>': Option<SwapWithDesiredOutput>;
    ...
    'Vec<BalancePrecision>': Vec<BalancePrecision>;
    ...
    'Vec<BridgeNetworkId>': Vec<BridgeNetworkId>;
    'Vec<BridgeStatus>': Vec<BridgeStatus>;
    'Vec<BridgeTimepoint>': Vec<BridgeTimepoint>;
    ...
    'Vec<EthPeersSync>': Vec<EthPeersSync>;
    ...
    'Vec<MarketMakerInfo>': Vec<MarketMakerInfo>;
    ...
    'Vec<MultiChainHeight>': Vec<MultiChainHeight>;
    'Vec<MultiCurrencyBalance>': Vec<MultiCurrencyBalance>;
    'Vec<MultiCurrencyBalanceOf>': Vec<MultiCurrencyBalanceOf>;
    ...
    'Vec<MultisigAccount>': Vec<MultisigAccount>;
    ...
    'Vec<OffchainRequest>': Vec<OffchainRequest>;
    ...
    'Vec<OutgoingMigrate>': Vec<OutgoingMigrate>;
    'Vec<OutgoingMigrateEncoded>': Vec<OutgoingMigrateEncoded>;
    ...
    'Vec<OutgoingTransfer>': Vec<OutgoingTransfer>;
    'Vec<OutgoingTransferEncoded>': Vec<OutgoingTransferEncoded>;
    'Vec<OverweightIndex>': Vec<OverweightIndex>;
    'Vec<Owner>': Vec<Owner>;
    'Vec<OwnerId>': Vec<OwnerId>;
    ...
    'Vec<PendingMultisigAccount>': Vec<PendingMultisigAccount>;
    ...
    'Vec<PermissionId>': Vec<PermissionId>;
    ...
    'Vec<QuoteWithDesiredInput>': Vec<QuoteWithDesiredInput>;
    'Vec<QuoteWithDesiredOutput>': Vec<QuoteWithDesiredOutput>;
    ...
    'Vec<SignatureParams>': Vec<SignatureParams>;
    ...
    'Vec<SmoothPriceState>': Vec<SmoothPriceState>;
    ...
    'Vec<SwapAmount>': Vec<SwapAmount>;
    'Vec<SwapOutcome>': Vec<SwapOutcome>;
    'Vec<SwapOutcomeInfo>': Vec<SwapOutcomeInfo>;
    'Vec<SwapVariant>': Vec<SwapVariant>;
    'Vec<SwapWithDesiredInput>': Vec<SwapWithDesiredInput>;
    'Vec<SwapWithDesiredOutput>': Vec<SwapWithDesiredOutput>;
    ...
    MultiChainHeight: MultiChainHeight;
    MultiCurrencyBalance: MultiCurrencyBalance;
    MultiCurrencyBalanceOf: MultiCurrencyBalanceOf;
    ...
    OffchainRequest: OffchainRequest;
    ...
    OutgoingMigrate: OutgoingMigrate;
    OutgoingMigrateEncoded: OutgoingMigrateEncoded;
    ...
    OutgoingTransferEncoded: OutgoingTransferEncoded;
    ...
    PendingMultisigAccount: PendingMultisigAccount;
    ...
    QuoteWithDesiredInput: QuoteWithDesiredInput;
    QuoteWithDesiredOutput: QuoteWithDesiredOutput;
    ...
    SlotRange: SlotRange;
    SmoothPriceState: SmoothPriceState;
    ...
    SwapWithDesiredInput: SwapWithDesiredInput;
    SwapWithDesiredOutput: SwapWithDesiredOutput;
    SyncState: SyncState;
