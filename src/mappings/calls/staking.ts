...
export async function stakingSetHistoryDepthCallHandler(extrinsic: SubstrateExtrinsic): Promise<void> {
  ...
  const {
    extrinsic: {
      args: { newHistoryDepth, eraItemsDeleted },
    },
  } = extrinsic as any;
