...
export * from './mappings/calls/bridgeProxy';
export * from "./mappings/calls/demeterFarmingPlatform";
export * from './mappings/calls/ethBridge';
export * from "./mappings/calls/extendedAssets";
export * from './mappings/calls/irohaMigration';
export * from "./mappings/calls/kensetsu";
export * from './mappings/calls/liquidityProxy';
export * from "./mappings/calls/orderBook";
export * from './mappings/calls/poolXYK';
